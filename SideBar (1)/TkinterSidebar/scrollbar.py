...
class ScrollBar(Frame):
    def __init__(self, parent):
        ...
        Frame.__init__(self, parent, width=self.width, height=self.height, bg="#0d0120")
        self.place(x=0, y=-2)
        ...
        self.c_frame = Frame(self, width=self.width, height=self.height, bg="#160530")
        self.c_frame.place(x=0, y=0)
        self.c_Canvas = Canvas(self.c_frame, width=self.width, height=self.height, bd=-2, bg="#0d0120")
        scrollbar = Scrollbar(self.c_frame, orient="vertical", command=self.c_Canvas.yview, bg="#160530")
