...
class Spacer(Canvas):
    def __init__(self, parent, text, *args, **kwargs):
        ...
        self.frame_color = "#0d0120"
        self.hover_border_color = "#0d0120"
        ...
        self.pack()
#change ap-corpora
        self.text = Label(self, text=text, bg=self.frame_color, font="Segoe 10 bold", fg="white")
...
class SideBarButton(Canvas):
    def __init__(self, parent, text, command, icon=None, tab=True, *args, **kwargs):
        ...
        self.frame_color = "#0d0120"
        self.hover_color = "#0d0120"
        self.hover_border_color = "#413650"
        self.is_tab = tab
        ...
        self.text = Label(self, text=text, font="Segoe 10", bg=self.frame_color, fg="white")
