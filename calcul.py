...
while (end <= 24):
  ...
  #-----------------------------------separation 1 -la moyenne harmonic-
        ...
        if harmonicAvg >= 0.80 and harmonicAvg <= 1:
            for h in range(len(list_h)):
              WriteInFIle.writeInFile("most Similar/harm_cyber"+str(start)+"_cyber"+str(end)+".txt", list_h[h], 1)

        elif 0.50 <= harmonicAvg < 0.80:
            for h in range(len(list_h)):
              WriteInFIle.writeInFile("low similar/harm_cyber"+str(start)+"_cyber"+str(end)+".txt", list_h[h], 1)

        else:
            for h in range(len(list_h)):
              WriteInFIle.writeInFile("poor similar/harm_cyber"+str(start)+"_cyber"+str(end)+".txt", list_h[h], 1)
  ...
  #-----------------separation 2 - la moyenne pond̩r̩ 1 -
        ...
        if ponderation1 >= 0.80 and ponderation1 <= 1:
            for p1 in range(len(list_p1)):
              WriteInFIle.writeInFile("most Similar/pond1_cyber"+str(start)+"_cyber"+str(end)+".txt", list_p1[p1], 1)
        elif 0.50 <= ponderation1 < 0.80:
            for p1 in range(len(list_p1)):
              WriteInFIle.writeInFile("low similar/pond1_cyber"+str(start)+"_cyber"+str(end)+".txt", list_p1[p1], 1)

        else:
            for p1 in range(len(list_p1)):
              WriteInFIle.writeInFile("poor similar/pond1_cyber"+str(start)+"_cyber"+str(end)+".txt", list_p1[p1], 1)
  ...
  #---------------------separation 3 - la moyenne pnd̩r̩ 2 -
        ...
        if ponderation2 >= 0.80 and ponderation2 <= 1:
            for p2 in range(len(list_p2)):
              WriteInFIle.writeInFile("most Similar/pond2_cyber"+str(start)+"_cyber"+str(end)+".txt", list_p2[p2], 1)


        elif 0.50 <= ponderation2 < 0.80:
            for p2 in range(len(list_p2)):
              WriteInFIle.writeInFile("low similar/pond2_cyber"+str(start)+"_cyber"+str(end)+".txt", list_p2[p2], 1)

        else:
            for p2 in range(len(list_p2)):
              WriteInFIle.writeInFile("poor similar/pond2_cyber"+str(start)+"_cyber"+str(end)+".txt", list_p2[p2], 1)
  ...
  #############Save results in file
        ...
        for z in range(len(list_z)):
              WriteInFIle.writeInFile("Result/cyber"+str(start)+"_cyber"+str(end)+".txt", list_z[z], 1)
  ################ save couple in separate file
        ...
        for y in range(len(list_y)):
              WriteInFIle.writeInFile("cyber couple result/couple_cyber"+str(start)+"_cyber"+str(end)+".txt", list_y[y], 1)
  ...
  ############### save similarity result in separate file
      ...
      for x in range(len(list_x)):
        WriteInFIle.writeInFile("cyber similarity couple result/sim_cyber"+str(start)+"_cyber"+str(end)+".txt", list_x[x], 1)
  end = end + 1
